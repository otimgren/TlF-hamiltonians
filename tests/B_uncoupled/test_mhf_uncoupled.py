...
from TlF_hamiltonians.B_uncoupled import H_mhf_F, H_mhf_Tl
...
class TestHmhfF:
    ...
    def test_hermitian(self, QN):
        ...
        message = "H_mhf_F in B_uncoupled is not Hermitian!"
...
class TestHmhfTl:
    ...
    def test_hermitian(self, QN):
        ...
        message = "H_mhf_Tl in B_uncoupled is not Hermitian!"
        assert np.allclose(M, M.conj().T), message
